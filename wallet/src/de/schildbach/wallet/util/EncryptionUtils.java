...
public class EncryptionUtils
{
	 ...
	 * files.
	 */
	private static final String OPENSSL_MAGIC_TEXT = new String(Base64.encode(EncryptionUtils.OPENSSL_SALTED_TEXT.getBytes(UTF8), Base64.DEFAULT),
			UTF8).substring(0, EncryptionUtils.NUMBER_OF_CHARACTERS_TO_MATCH_IN_OPENSSL_MAGIC_TEXT);
