...
public class GenericUtilsTest
{
	...
	{
		assertEquals("1.00", GenericUtils.formatValue(Coin.COIN, 4, 0));
		assertEquals("1.00", GenericUtils.formatValue(Coin.COIN, 6, 0));
		assertEquals("1.00", GenericUtils.formatValue(Coin.COIN, 8, 0));
	...
	{
		assertEquals("1000.00", GenericUtils.formatValue(Coin.COIN, 2, 3));
		assertEquals("1000.00", GenericUtils.formatValue(Coin.COIN, 4, 3));
	...
	{
		assertEquals("1000000", GenericUtils.formatValue(Coin.COIN, 0, 6));
		assertEquals("1000000", GenericUtils.formatValue(Coin.COIN, 2, 6));
