...
public class Utils {
    ...
    public static final BigInteger MILLICENT = new BigInteger("10000", 10);
    ...
    /** Returns the given value in nanocoins as a 0.12 or 0.1234 type string. */
    public static String bitcoinValueToFriendlyString(BigInteger value) {
        boolean negative = value.compareTo(BigInteger.ZERO) < 0;
        if (negative)
            value = value.negate();
        final int coins = value.divide(COIN).intValue();
